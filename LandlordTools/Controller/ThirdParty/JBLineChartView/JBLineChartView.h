...
- (NSInteger)minBandLevelString:(JBLineChartView*)eqView;

- (NSInteger)middleBandLevelString:(JBLineChartView*)eqView;

- (NSInteger)maxBandLevelString:(JBLineChartView*)eqView;

- (NSString*)titleForBand:(JBLineChartView*)eqView withIndex:(NSInteger)index;
