...
@protocol NMRangeDelegate <NSObject>

- (void)sliderValueChanged:(NMRangeSlider*)slider lowwerValue:(float)lowerValue upperValue:(float)upperValue;

@end

@interface NMRangeSlider : UIControl

@property (nonatomic, weak) IBOutlet NSObject<NMRangeDelegate>* delegate;
