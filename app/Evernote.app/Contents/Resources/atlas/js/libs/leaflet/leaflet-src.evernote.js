...
/*
   Modified by Alec Winograd 7/16/2012
   For atlas, we wanted the big maps not to resize due to performance reasons
   Search for "Modified by" to find the modification
*/
/*
